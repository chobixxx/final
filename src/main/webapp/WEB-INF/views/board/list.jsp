...
<div align="center">
<span>
<a href="/NoticeServlet/noticeallview">
...
<div align="right">
  <a href="${pageContext.request.contextPath}/company/logout">Logout</a>
						...
						<c:choose>
							...
							<c:otherwise>
								...
								<c:forEach items="${requestScope.allData}" var="e">
									...
									<tr>
										<td>${e.no}</td>
										<th><a href="../board/boardread?no=${e.no}">${e.title}</a></th>
										<td>${e.empNo.name}</td>
										<td>${e.writedate}</td>
									</tr>
	...
	<br>
	<div align="right">
	<button type="button" onclick="location.href = '../board/boardinsert'" style="background-color:#555">
