		...
		<div class="top">
			...
			<nav id="nav">
				<ul>
					...
					<li><a href="${pageContext.request.contextPath}/message/viewmessage/${sessionScope.empNo}" id="portfolio-link"><span class="icon solid fa-envelope">메시지</span></a></li>
					<li><a href="${pageContext.request.contextPath}/todolist/viewtodolist/${sessionScope.empNo}" id="portfolio-link"><span class="icon solid fa-envelope">Todolist</span></a></li>
				</ul>
			</nav>
